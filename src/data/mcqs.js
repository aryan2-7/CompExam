...
const RAW = [
  [
    ...
    [
      ...
      ["If a class is derived from a class using the keyword class means, what will happen in the program?", ["Access is private by default", "Access is protected by default", "None of the mentioned"], 0, "certain"],
  ...
  [
    ...
    [
      ...
      ["The catch statement to catch a string thrown from the try block is", ["catch(char s[])", "catch(string s)", "catch(char const *s)", "catch(...)"], 1, "certain"],
  ...
  [
    ...
    [
      ...
      ["What is the output of the following program:\n`int main() { if(0) { cout<<\"Hi\"; } else { cout<<\"Bye\"; } return 0; }`", ["Bye", "Hi", "HiBye", "Compilation Error"], 0, "certain"],
      ...
      ["What is the output of the following program:\n`#include<iostream.h>`\n`void Execute(int &x, int y=200) { int TEMP=x+y; x+=TEMP; if(y!=200) cout<<TEMP<<x<<y<<\"--\"; }`\n`int main() { int A=50, B=20; cout<<A<<B<<\"--\"; Execute(A,B); cout<<A<<B<<\"--\"; return 0; }`", ["5020--5020--", "5020--70120200--5020", "5020--701202012020--", "5020--7050200--5020--"], 0, "likely"],
      ["In the following:\n`class X{ int fun1(); };`\n`class Y{ friend int X::fun1(); };`", ["Function fun1() is member of class Y and friend of class X.", "Function fun1() is member of class X and friend of class Y.", "Function fun1() is member of class X and friend of class X.", "Function fun1() is member of class Y and friend of class Y."], 1, "certain"],
      ...
      ["What is the output of following C++ program:\n`int i; class A { public: ~A(){ i=10; } }; int foo(){ i=3; A ob; return i; } int main(){ cout << foo() << endl; return 0; }`", ["3", "0", "10", "13"], 0, "certain"],
      ...
      ["What will happen in this code?\n`int a=100, b=200; int *p=&a, *q=&b; p=q;`", ["b is assigned to a", "p now points to b", "a is assigned to b", "q now points to a"], 1, "certain"],
      ...
      ["Template in C++,", ["Is way of achieving procedural programming", "Is way of achieving generic programming", "Is way of achieving object oriented programming", "Uses the type of the data that is operated upon need not be specified as a parameter"], 2, "certain"],
  ...
  [
    ...
    [
      ...
      ["In the given code section:\n`class X{};` `class Y{ X a; };`", ["Class X is friend of Class Y", "Class X is composed of Class X", "Class Y is friend of class Y", "Class Y composed of class X"], 3, "certain"],
  ...
  [
    ...
    [
      ...
      ["What will be the output of the following C++ code?\n`int a=10, b, c; b=a++; c=a; cout<<a<<\" \"<<b<<\" \"<<c<<endl;`", ["10 11 11", "11 11 11", "11 10 11", "10 10 10"], 2, "certain"],
      ...
      ["What will be the output of the following C code?\n`char ch[] = \"Interviewbit Scaler\"; int l = strlen(ch); cout << l << endl;`", ["18", "19", "20", "21"], 1, "certain"],
      ...
      ["Which is the CORRECT statement about operator overloading?", ["Only arithmetic operators can be overloaded", "Only non-arithmetic operators can be overloaded", "Precedence of operators are changed after overloading", "Associativity and precedence of operators does not change"], 2, "certain"],
      ["Which of the following can be considered as the correct syntax for declaring an array of pointers of integers that has a size of 5 in C++?", ["int arr=new int[5];", "int *arr=new int[5];", "int **arr=new int*[5];", "int *arr=new int[5];"], 1, "likely"],
      ["Which feature of OOP is indicated by the following code?\n`class student{int marks;}; class topper: public student{int age; topper(int age){this.age=age;}};`", ["Encapsulation and inheritance", "polymorphism", "Inheritance and polymorphism", "inheritance"], 0, "certain"],
  ...
  [
    ...
    [
      ...
      ["What is the output of the following code:\n`class Test { int x; }; int main() { Test t; cout << t.x; return 0; }`", ["Compiler Error", "0", "Garbage Value", "undefined"], 0, "certain"],
      ...
      ["If we attempt to dereference an uninitialized pointer, it will ___ by referring to any other location in memory.", ["cause a compile time error", "run time error", "cause run time error", "executes"], 3, "likely"],
      ...
      ["Generic catch handler is represented by", ["catch(...)", "catch()", "catch(...)", "catch(void x)"], 0, "certain"]
    ]
  ]
];
